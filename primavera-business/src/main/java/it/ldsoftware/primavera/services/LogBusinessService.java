...
import it.ldsoftware.primavera.services.interfaces.LogService;
 ...
 */
@Service
public class LogBusinessService extends AbstractBusinessService<LogEntryDTO, LogEntry> implements LogService {
