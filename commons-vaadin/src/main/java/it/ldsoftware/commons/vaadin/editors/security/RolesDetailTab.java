...
import it.ldsoftware.commons.entities.security.QRole;
...
import it.ldsoftware.commons.vaadin.data.util.converters.BoolConverter;
...
import static it.ldsoftware.commons.dto.security.UserRoleDTO.*;
import static it.ldsoftware.commons.i18n.CommonLabels.*;
import static it.ldsoftware.commons.util.UserUtil.getCurrentUser;
...
public class RolesDetailTab extends MVerticalLayout {
    ...
    private String getCaption(Object o) {
        return ((Role) o).getTranslation(getLocale()).getContent();
    }
