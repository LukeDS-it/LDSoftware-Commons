...
import it.ldsoftware.commons.services.DummyUserDetailService;
...
import static it.ldsoftware.commons.util.UserUtil.ROLE_DB_CONSOLE;
import static it.ldsoftware.commons.util.UserUtil.ROLE_SUPERADMIN;
import static it.ldsoftware.commons.vaadin.configuration.CommonsVaadinConfig.ADDRESS_DB_CONSOLE;
...
public class BaseSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(ADDRESS_DB_CONSOLE + "/*").hasAnyAuthority(ROLE_DB_CONSOLE, ROLE_SUPERADMIN)
